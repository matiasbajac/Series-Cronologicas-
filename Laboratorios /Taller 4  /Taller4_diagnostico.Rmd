...
pib <- read_excel(here("Taller4_diagnostico", "PIB_sectorial.xlsx"),
...
```{r, fig.align = 'center', fig.cap = "Gráfico y autocorrelograma del cuadrado de los residuos de un modelo AR(2) para el PIB del sector Comercio, alojamiento y suministro de comidas y bebidas (millones de pesos a precios constantes de 2016) entre 2016 y 2023.", fig.pos = 'H'}
...
```{r, fig.align = 'center', fig.cap = "Predicciones en el conjunto de prueba del PIB del sector Comercio, alojamiento y suministro de comidas y bebidas (millones de pesos a precios constantes de 2016) para un modelo AR(2). La línea azul corresponde a las predicciones.", fig.pos = 'H'}
